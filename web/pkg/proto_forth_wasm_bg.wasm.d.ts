...
export const machine_load_source: (a: number, b: number, c: number) => void;
export const machine_load_state: (a: number, b: number, c: number) => number;
export const machine_new: () => number;
export const machine_reset: (a: number) => void;
export const machine_save_state: (a: number) => [number, number];
