/* @ts-self-types="./proto_forth_wasm.d.ts" */
...
export class Machine {
    ...
    eval_repl(line) {
        ...
        wasm.machine_eval_repl(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {string}
     */
    get_dictionary_text() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.machine_get_dictionary_text(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get_history_text() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.machine_get_history_text(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_output_text() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.machine_get_output_text(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_stack_text() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.machine_get_stack_text(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_trace_text() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.machine_get_trace_text(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./proto_forth_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('proto_forth_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
